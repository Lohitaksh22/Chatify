...
export default function MessageBubbleComponent({
  ...
  <div className="my-4 h-full flex flex-col items-center gap-3">
    ...
    prev ? new Date(prev.createdAt) : undefined
        ...
        return (
          ...
          >
            ...
            {showDateDivider && (
        <DateDivider label={dateCalc(m.createdAt) ?? ""} />
      )}
            ...
            >
              ...
              <div className=" flex items-center justify-center ml-1 text-[10px] italic ">
                {m.id === lastMessageId && readCount === 0 && isMine && (m.edit===true) && (
                  <span>Edited and Delivered {dateCalc(m.createdAt)}</span>
                )}
                {m.id === lastMessageId && readCount === 0 && isMine && (m.edit===false) && (
                  <span>Delivered {dateCalc(m.createdAt)}</span>
                )}
                ...
                {!showReadCount && m.id === lastMessageId && isMine && (
      ...
      {editingMessageId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-lg min-h-screen">
          <div className="  rounded-xl shadow-2xl p-4 w-full max-w-lg bg-[radial-gradient(1200px_circle_at_20%_-10%,rgba(56,189,248,0.25),transparent_40%),radial-gradient(900px_circle_at_80%_10%,rgba(168,85,247,0.25),transparent_45%)] border border-white/20">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <button
                  onClick={saveEdit}
                  className="px-3 py-1 rounded bg-sky-600 hover:bg-sky-800 active:scale-105 text-white"
                >
                  Save
                </button>
              </div>
